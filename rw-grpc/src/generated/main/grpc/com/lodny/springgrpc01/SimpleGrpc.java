...
@javax.annotation.Generated(
    ...
    comments = "Source: tag/tag.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class SimpleGrpc {

  private SimpleGrpc() {}

  public static final java.lang.String SERVICE_NAME = "com.lodny.springgrpc01.Simple";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.lodny.springgrpc01.HelloRequest,
      com.lodny.springgrpc01.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.lodny.springgrpc01.HelloRequest.class,
      responseType = com.lodny.springgrpc01.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.lodny.springgrpc01.HelloRequest,
      com.lodny.springgrpc01.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.lodny.springgrpc01.HelloRequest, com.lodny.springgrpc01.HelloResponse> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.lodny.springgrpc01.HelloRequest, com.lodny.springgrpc01.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lodny.springgrpc01.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lodny.springgrpc01.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(com.lodny.springgrpc01.HelloRequest request,
        io.grpc.stub.StreamObserver<com.lodny.springgrpc01.HelloResponse> responseObserver) {
  ...
  public static final class SimpleStub
    ...
    /**
     */
    public void sayHello(com.lodny.springgrpc01.HelloRequest request,
        io.grpc.stub.StreamObserver<com.lodny.springgrpc01.HelloResponse> responseObserver) {
  ...
  public static final class SimpleBlockingStub
    ...
    /**
     */
    public com.lodny.springgrpc01.HelloResponse sayHello(com.lodny.springgrpc01.HelloRequest request) {
  ...
  public static final class SimpleFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.lodny.springgrpc01.HelloResponse> sayHello(
        com.lodny.springgrpc01.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.lodny.springgrpc01.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.lodny.springgrpc01.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.lodny.springgrpc01.HelloRequest,
              com.lodny.springgrpc01.HelloResponse>(
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.lodny.springgrpc01.Tag.getDescriptor();
    }
